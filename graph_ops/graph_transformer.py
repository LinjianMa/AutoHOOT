...
def optimize_inverse_orghogonal(inv_node):
    ...
    if len(subs_input) == 2 and inode.inputs[0] == inode.inputs[1] and subs_input[0][0] == subs_input[1][0] and subs_input[0][1] != subs_input[1][1] and {subs_input[0][1], subs_input[1][1]} == set(subs[1]):
